...
def test_year_dec_boundary():
    assert normalize_year("Dec-99") == "2099-12"


def test_year_fy_boundary():
    assert normalize_year("FY00") == "2000-03"
...
def test_year_timestamp():
    assert normalize_year("2024-03-31") == "2024-03"
